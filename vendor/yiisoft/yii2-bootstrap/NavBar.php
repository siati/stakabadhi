...
class NavBar extends Widget {
     ...
     * @param string $class2 class2
     * @return string html element
     */
    public static function linkHelper($class, $url, $method, $elements, $label, $class2) {
        return
                "<li class='$class'>"
                . Html::beginForm([$url], $method)
                . $elements
                . Html::submitButton($label, ['class' => "btn btn-link $class2", 'formaction' => \Yii::$app->request->baseUrl . $url])
                . Html::endForm()
                . '</li>';
    }
