...
class Model extends Component implements IteratorAggregate, ArrayAccess, Arrayable {
     ...
     */
    public function notNumerical($attribute) {
        if (is_numeric($this->$attribute))
            $this->addError($attribute, $this->getAttributeLabel($attribute) . ' cannot be a number');
    }
    ...
    public function kenyaPhoneNumber($attribute) {
        is_numeric($this->$attribute) &&
                ...
                ) ? $this->$attribute = '+2547' . substr($this->$attribute, -8) : $this->addError($attribute, 'Invalid phone number');
    }
     ...
     */
    public function toLowerCase($attribute) {
     ...
     * @param string $attribute attribute of [[$this]]
     */
    public function toUpperCase($attribute) {
     ...
     * @param string $attribute attribute of [[$this]]
     */
    public function sentenceCase($attribute) {
        $this->$attribute = ucfirst(strtolower($this->$attribute));
    }
     ...
     * @param string $attribute attribute of [[$this]]
     */
    public function capitalizeEachWord($attribute) {
     ...
     * @param string $attribute attribute of [[$this]]
     */
    public function paragraphCase($attribute) {
        $this->$attribute = StaticMethods::paragraphCase($this->$attribute);
    }
