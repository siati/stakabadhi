...
class SubCompartments extends \yii\db\ActiveRecord {
    ...
    public function permission() {
        return $this->isNewRecord ? Compartments::returnCompartment($this->compartment)->permission() : FilePermissions::byStoreLevelAndId(StoreLevels::subcompartments, $this->id);
    }
